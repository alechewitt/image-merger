...
},{"../../modules/$":33}],7:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/es6.string.iterator');
require('../modules/web.dom.iterable');
require('../modules/es6.promise');
module.exports = require('../modules/$.core').Promise;
},{"../modules/$.core":12,"../modules/es6.object.to-string":55,"../modules/es6.promise":56,"../modules/es6.string.iterator":57,"../modules/web.dom.iterable":58}],8:[function(require,module,exports){
...
},{"./$.cof":11,"./$.wks":52}],11:[function(require,module,exports){
...
},{"./$.global":19,"./$.is-object":25}],17:[function(require,module,exports){
...
},{"./$.an-object":9,"./$.ctx":13,"./$.is-array-iter":24,"./$.iter-call":27,"./$.to-length":48,"./core.get-iterator-method":53}],19:[function(require,module,exports){
...
},{"./$":33,"./$.property-desc":36,"./$.support-desc":44}],22:[function(require,module,exports){
...
},{"./$.iterators":32,"./$.wks":52}],25:[function(require,module,exports){
...
},{"./$":33,"./$.hide":21,"./$.property-desc":36,"./$.tag":45,"./$.wks":52}],29:[function(require,module,exports){
'use strict';
...
},{"./$":33,"./$.def":14,"./$.has":20,"./$.hide":21,"./$.iter-buggy":26,"./$.iter-create":28,"./$.iterators":32,"./$.library":34,"./$.redef":37,"./$.tag":45,"./$.wks":52}],30:[function(require,module,exports){
...
},{"./$.wks":52}],31:[function(require,module,exports){
...
},{"./$.redef":37}],36:[function(require,module,exports){
...
},{"./$.hide":21}],38:[function(require,module,exports){
...
},{"./$":33,"./$.an-object":9,"./$.ctx":13,"./$.is-object":25}],40:[function(require,module,exports){
var global = require('./$.global')
...
},{"./$.global":19}],41:[function(require,module,exports){
var $       = require('./$')
...
},{"./$":33,"./$.support-desc":44,"./$.wks":52}],42:[function(require,module,exports){
...
},{"./$.defined":15,"./$.to-integer":47}],44:[function(require,module,exports){
...
},{"./$.has":20,"./$.hide":21,"./$.wks":52}],46:[function(require,module,exports){
'use strict';
var ctx                = require('./$.ctx')
...
},{"./$.cof":11,"./$.ctx":13,"./$.dom-create":16,"./$.global":19,"./$.html":22,"./$.invoke":23}],47:[function(require,module,exports){
// 7.1.4 ToInteger
var ceil  = Math.ceil
  , floor = Math.floor;
module.exports = function(it){
...
},{"./$.defined":15,"./$.es5-object":17}],50:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./$.global":19,"./$.shared":40,"./$.uid":50}],53:[function(require,module,exports){
var global    = require('./$.global')
...
},{"./$.classof":10,"./$.core":12,"./$.global":19,"./$.iterators":32,"./$.wks":52}],54:[function(require,module,exports){
...
setUnscope('values');
setUnscope('entries');
},{"./$.iter-define":29,"./$.iter-step":31,"./$.iterators":32,"./$.to-object":49,"./$.unscope":51}],55:[function(require,module,exports){
...
},{"./$":33,"./$.a-function":8,"./$.an-object":9,"./$.classof":10,"./$.core":12,"./$.ctx":13,"./$.def":14,"./$.for-of":18,"./$.global":19,"./$.is-object":25,"./$.iter-detect":30,"./$.library":34,"./$.mix":35,"./$.same":38,"./$.set-proto":39,"./$.species":41,"./$.strict-new":42,"./$.support-desc":44,"./$.tag":45,"./$.task":46,"./$.uid":50,"./$.wks":52}],57:[function(require,module,exports){
...
},{"./$.iter-define":29,"./$.string-at":43}],58:[function(require,module,exports){
require('./es6.array.iterator');
var Iterators = require('./$.iterators');
Iterators.NodeList = Iterators.HTMLCollection = Iterators.Array;
},{"./$.iterators":32,"./es6.array.iterator":54}],59:[function(require,module,exports){
...
var _vertexShaderVert2 = _interopRequireDefault(_vertexShaderVert);

var _fragmentShaderFrag = require("./fragment-shader.frag");
...
var PaternizeApp = (function () {
    function PaternizeApp(canvas, desiredSize) {
        _classCallCheck(this, PaternizeApp);

        this.canvas = canvas;
        var size = Math.min(IMAGE_SIZE, desiredSize);
    ...
    _createClass(PaternizeApp, [{
        ...
        value: function init() {
            ...
            var shaderProg = this.createShaderProgram_((0, _vertexShaderVert2["default"])(), (0, _fragmentShaderFrag2["default"])());
            ...
            var self = this;
            this.loadImage(self.image0Src).then(function (image) {
        ...
        key: "updatePatternScale",
        value: function updatePatternScale(value) {
        ...
        key: "setImageCoords",
        value: function setImageCoords(shaderProg) {
            var attributeCoords = this.gl.getAttribLocation(shaderProg, "a_coords");
            this.gl.enableVertexAttribArray(attributeCoords);

            // Set Up Draw buffer draw coords
            var bufferCoords = this.gl.createBuffer();
        ...
        key: "bindTexturesToTextureUnits",
        value: function bindTexturesToTextureUnits(program) {
            // First Get location of our uniform variables in the fragment shader
            var uImage0 = this.gl.getUniformLocation(program, "u_image0");
            var uImage1 = this.gl.getUniformLocation(program, "u_image1");
            var uPattern = this.gl.getUniformLocation(program, "u_pattern");
        ...
        value: function createShaderProgram_(vertexShaderSource, fragmentShaderSource) {
            ...
            var fsh = this.gl.createShader(this.gl.FRAGMENT_SHADER);
